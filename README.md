## Docker + OnlyOffice instalazioa + SMBClient

Honekin docker bidez, NextCloud, OnlyOffice eta sareko unitateak mapeatzeko SmbClient konfiguratuko dugu. Moldaketa eginda SMBClient gehitzeko. Jarraitu repo originaleko jarraibideak instalatzeko:
...
1. Get the latest version of this repository running the command:
    ...
    ```
    git clone https://github.com/ikerib/nextcloud-onlyoffice-smbclient nextcloud
    cd nextcloud
    ```
